...
console.log(mainFunc(2, 5, 'не функция')); // false 

function cbRandom(min, max) {
    return Math.floor(Math.random() * (max - min + 1) + min);
};

console.log(mainFunc(2, 5, cbRandom)); // рандомное число от 2 до 5 (включительно)
console.log(mainFunc(10, 30, cbRandom)); // рандомное число от 10 до 30 (включительно)
